...
function TaskCreator(props) {
    ...
    const submitNewTask = (event) => {
        ...
        fetch(
            `http://localhost:${process.env.REACT_APP_BACKEND_PORT}/tasks/create`,
            {
                method: 'post',
                body: data,
            }
        ...
        <form className='submit-form bordered' onSubmit={submitNewTask}>
            ...
            <div className='inputwrapper'>
                ...
                <input
                    ...
                    value={url}
                    placeholder='Viewkey of a YouTube video (the part after /watch?v= in the URL), e.g., dQw4w9WgXcQ'
                ></input>
            </div>
